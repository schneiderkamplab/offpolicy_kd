#!/bin/bash
pip install
mld-regmix test/mixture/test.txt --val-data-files test/gemma3/train_test2.parquet --num-epochs 10 --val-every 10 --save-every 10
mld-regmix test/mixture/test.txt --val-data-files test/gemma3/train_test2.parquet --num-epochs 10 --val-every 10 --save-every 10 --pretrained
mld-regmix test/mixture/test.txt --val-data-files test/gemma3/train_test2.parquet --num-epochs 10 --val-every 10 --save-every 10 --distillation
mld-regmix test/mixture/test.txt --val-data-files test/gemma3/train_test2.parquet --num-epochs 10 --val-every 10 --save-every 10 --pretrained --distillation
