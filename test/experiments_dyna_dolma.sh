...
export JOBID=olmo1b_NOdistill_dyna-cp_def

export STUDENT_MODEL="models/olmo-1b"
export TEACHER_MODEL="models/olmo-1b"

export TRAIN_DATASET="data/distillOlmo/distill-dyna-cp-dyna-0-of-1-cp-0-of-16-train"
export VAL_DATASET="data/distillOlmo/distill-dyna-cp-dyna-0-of-1-cp-0-of-16-test"
